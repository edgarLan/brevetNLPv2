...
from utils import pmi_to_dict, pmi_to_dict2
...
class Surprise():
    ...
    def get_common_vectors2(self, dict_old, dict_new, epsilon):
        """ Input : nested dictionaries for each PMI collocations
        Ouput : list of tuples vectors for each words """
        w1_old = dict_old['w1']
        w1_new = dict_new['w1']
        ...
        print("interList_w1: ", interList_w1)
        print("interList_w2: ", interList_w2)
    ...
    def uniq_surprise2(self, dict_known, eps= 0.000001, thr_surp=0.):
        """ On compare la distribution avec en sans new_Q -- on compare la divergence JSD moyenne de ces deux distributions"""
        dict_new = pmi_to_dict2(self.pmi_new)
        vecotr_tuples = self.get_common_vectors2(dict_known, dict_new, epsilon = eps)
